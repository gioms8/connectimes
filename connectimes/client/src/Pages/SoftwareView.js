...
class SoftwareView extends Component {
    ...
    callSwToolInfoApi = async () => {
        ...
        .then( response => {
            try {
                ...
                alert('작업중 오류가 발생하였습니다. (SoftwareView1)')
            }
        })
        .catch( error => {alert('작업중 오류가 발생하였습니다. (SoftwareView2) ' +error );return false;} );
    }
        ...
        if(this.fnValidate()){
            ...
            try {
                ...
                if(body == "succ"){
                    ...
                    alert('작업중 오류가 발생하였습니다. (SoftwareView3)')
                }  
            } catch (error) {
                alert('작업중 오류가 발생하였습니다. (SoftwareView4)')
            }
        }
    };
    ...
    handlePostMenual(){
        ...
        return axios.post("/api/upload?type=uploads/swmanual/", formData).then(res => {
            ...
            alert('작업중 오류가 발생하였습니다. (SoftwareView5)', error, 'error', '닫기')
        })
    }    
    ...
    handlePostImage(type){
        ...
        return axios.post("/api/upload?type=uploads/image/", formData).then(res => {
            ...
            alert('작업중 오류가 발생하였습니다. (SoftwareView6)')            
        })
    }
                            ...
                            <article class="res_w">
                                ...
                                <div class="tb_outline">
                                    ...
                                    <div class="btn_confirm mt20" style={{"margin-bottom": "44px"}}>
                                        <Link to={'/Home'} className="bt_ty bt_ty1 cancel_ty1">취소</Link>
